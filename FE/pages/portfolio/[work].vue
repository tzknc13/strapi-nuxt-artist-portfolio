      ...
      <div v-if="show && workdata">
        <div class="grid grid-cols-6 gap-4">
          <div class="col-start-5 col-span-2 flex justify-end md:justify-end flex items-center my-6 md:my-2">
            <button
              class="bg-transparent transition duration-500 ease-in-out hover:bg-gray-100 dark:hover:bg-gray-800 text-gray-800 dark:text-gray-100 font-bold py-2 px-4 rounded transform hover:-translate-y-1 hover:scale-105"
              @click="show = false"
            >
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="bi bi-x-lg text-gray-400 dark:text-gray-500" viewBox="0 0 16 16" stroke="currentColor">
