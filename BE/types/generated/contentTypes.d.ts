...
export interface ApiCategoryCategory extends Schema.CollectionType {
  ...
  attributes: {
    ...
    description: Attribute.RichText &
      Attribute.DefaultTo<'// toto je volitelne'>;
    position_in_view: Attribute.Integer & Attribute.DefaultTo<0>;
...
export interface ApiCvCv extends Schema.SingleType {
  ...
  attributes: {
    ...
    portrait_photo: Attribute.Media<'images' | 'files' | 'videos'>;
    publishedAt: Attribute.DateTime;
...
export interface ApiWorkWork extends Schema.CollectionType {
  ...
  attributes: {
    ...
    images: Attribute.Media<'files' | 'images' | 'videos', true> &
      Attribute.Required;
    medium: Attribute.String;
    position_in_view: Attribute.Integer;
    publishedAt: Attribute.DateTime;
    single_image: Attribute.Media<'files' | 'images' | 'videos'> &
      Attribute.Required;
